#math string recursion good
# enumerate(iterable, startposition)
...
class Solution(object):
    def numberToWords(self, num):
        ...
        def word(num):
            if num < 20:
                # num = 0, list[-1:0] -> [] rather than ['']-> so that ignore this one ->so that extra ' ' would not be added
                return under20[num-1:num]
